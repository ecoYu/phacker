...
{p 4 4 2}
{hi:phacker} —— Helps you to quickly screen for control variables that keep all variables at a certain level of significance in regression.{p_end}
...
{p_end}
{synopt:{opt unrestrict}}does not restrict whether the coefficients of keepvar and cons term are statistically significant
{p_end}
